                    ...
                    <div class="widget footer-widget">
                        ...
                        <div class="th-widget-contact">
                            <div class="info-box">
                                ...
                                <p class="box-text">Auckland,New Zealand</p>
                            </div>
                            <div class="info-box">
                                <div class="box-icon">
                                ...
                                <p class="box-text">
                                    <a href="tel:+163217322978" class="box-link">+64 22 356 8614</a>
                                </p>
                            </div>
                            <div class="info-box">
                                <div class="box-icon">
                                ...
                                <p class="box-text">
                                    <a href="mailto:info@codyzea.com" class="box-link">info@codyzea.com</a>
                                </p>
                            </div>
                            <div class="info-box">
                                <div class="box-icon">
