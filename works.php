...
<!-- End Google Tag Manager (noscript) -->
  ...
  ==============================-->
    ...
    <div class="container space-extra2" data-track="Works Hero Section">
        <div class="row">
            <div class="col-12 col-lg-6 d-flex justify-content-center align-items-center flex-column">
                <div class="p-5 d-flex justify-content-center flex-column">
                    <span class="display-1 text-black">Our Works</span>
                    <p class="text-black fs-2 fw-semibold">
                        Bringing innovative digital solutions to life. Explore our work and see how we elevate
                        businesses.
                    </p>
                    <div class="btn-group">
            ...
            <div class="col-12 col-lg-6">
                <img src="assets/works.jpg" class="img-fluid" alt="">
            </div>

        </div>
    </div>

    <section class="project-area2 position-relative space overflow-hidden" data-track="Works Loads Section" id="project-sec">
        <div class="container">
            <div class="row justify-content-lg-between justify-content-center align-items-end">
                <div class="col-lg-7">
                    <div class="title-area text-center text-lg-start pe-xl-5">
                        <div class="shadow-title style3">Our Work</div>
                        <span class="sub-title sub-title4 style1 text-ani-style2">Our Work</span>
