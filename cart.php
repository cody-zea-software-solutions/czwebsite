        ...
        <div class="container-fluid p-5">
            ...
            <div class="woocommerce-notices-wrapper d-none">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 mt-5 bg-color p-4 rounded-20">
                        <h2 class="h3 summary-title text-center">Package Totals</h2>
                        <table class="cart_totals mt-4 border-0">
                            <tbody class="bg-transparent">
                                ...
                                <tr>
                                    ...
                                    <td data-title="Cart Subtotal">
                                        <span class="amount h6"><bdi><span>-
                                                    NZ$</span><?php echo $discount; ?></bdi></span>
                                    </td>
                                </tr>
                            </tbody>
                            ...
                            <tfoot>
                                <tr class="order-total">
                                    ...
                                    <td data-title="Total">
                                        <strong><span
                                                class="amount h6"><bdi><span>&nbsp;&nbsp;&nbsp;NZ$</span><?php echo $final_price; ?></bdi></span></strong>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
