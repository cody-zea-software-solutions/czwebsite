...
<head>
    ...
    <title>Cody Zea : Fast, Reliable, Custom POS Solutions</title>
...
<body style="overflow-x: hidden !important;">
    ...
    <div class="container-fluid p-5 mt-5 bg-color" style="margin-top: 130px !important;">
        ...
        <div class="row mt-3 mb-4 text-center d-flex justify-content-center">
            <h2 class="fw-bold">
                Streamline Your Sales with<br>
                <span class="h1 text-orange">Powerful Features Built for Retail</span><br>
                Sell faster. Manage easier. Grow smarter.
            </h2>
        </div>
            ...
            <div class="col-10 col-lg-5 bg-white rounded-20 shadow-lg p-5 mt-3 mx-3">
                ...
                <div class="col-12 mt-3">
                    ...
                    <p class="text-o fw-normal fs-5">
                        Tailored systems built specifically for retail, salons, and small businesses.
                    </p>
                </div>
            </div>
            <div class="col-10 col-lg-5 bg-white rounded-20 shadow-lg p-5 mt-3 mx-3">
                ...
                <div class="col-12 mt-3">
                    ...
                    <p class="text-o fw-normal fs-5">
                        Fast, intuitive checkout process designed to speed up your sales.
                    </p>
                </div>
            </div>
            <div class="col-10 col-lg-5 bg-white rounded-20 shadow-lg p-5 mt-3 mx-3">
                ...
                <div class="col-12 mt-3">
                    ...
                    <p class="text-o fw-normal fs-5">
                        Track stock levels and products easily with real-time updates.
                    </p>
                </div>
            </div>
            <div class="col-10 col-lg-5 bg-white rounded-20 shadow-lg p-5 mt-3 mx-3">
                ...
                <div class="col-12 mt-3">
                    ...
                    <p class="text-o fw-normal fs-5">
                        Gain daily sales reports and insights to grow your business smarter.
                    </p>
                </div>
            </div>
            <div class="col-10 col-lg-5 bg-white rounded-20 shadow-lg p-5 mt-3 mx-3">
                ...
                <div class="col-12 mt-3">
                    ...
                    <p class="text-o fw-normal fs-5">
                        Control staff access and permissions with flexible role settings.
                    </p>
                </div>
            </div>
            <div class="col-10 col-lg-5 bg-white rounded-20 shadow-lg p-5 mt-3 mx-3">
                ...
                <div class="col-12 mt-3">
                    ...
                    <p class="text-o fw-normal fs-5">
                        Connect easily with accounting tools like Xero and popular ERPs.
                    </p>
                </div>
            </div>
        </div>
                ...
                <ul class="list-unstyled mt-4 border shadow p-2 p-md-5">
                    <li class="h6 text-o mt-3">
                        <div class="list-item">
                            ...
                            <span>Customizable POS workflows tailored for retail, salons, and small businesses.</span>
                        </div>
                    </li>
                    <li class="h6 text-o mt-3">
                        <div class="list-item">
                            <i class="fas fa fa-check me-3 text-orange"></i>
                            <span>Fast, intuitive billing interface to speed up customer checkouts.</span>
                        </div>
                    </li>
                    <li class="h6 text-o mt-3">
                        <div class="list-item">
                            <i class="fas fa fa-check me-3 text-orange"></i>
                            <span>Real-time inventory tracking and product management to reduce stock issues.</span>
                        </div>
                    </li>
                    <li class="h6 text-o mt-3">
                        <div class="list-item">
                            <i class="fas fa fa-check me-3 text-orange"></i>
                            <span>Comprehensive sales reporting and insights to drive smarter business decisions.</span>
                        </div>
                    </li>
                    <li class="h6 text-o mt-3">
                        <div class="list-item">
                            <i class="fas fa fa-check me-3 text-orange"></i>
                            <span>Role-based user management for secure and efficient staff access control.</span>
                        </div>
                    </li>
                    <li class="h6 text-o mt-3">
                        <div class="list-item">
    ...
    <div class="container px-5 my-5 pt-5">
        <div class="row">
            <div class="col-12 text-center px-4 py-5 bg-black" style="border-radius: 80px;">
                <div class="text-white h2 mb-5">
                    Ready to Transform Your Sales Experience?<br>
    ...
    <div class="container px-5 mt-5 pt-5" style="display: none !important;">
    ...
    <div class="container px-4 px-md-5 mt-5 pt-5">
        <div class="row">
            <div class="col-12 text-center bg-black p-4" style="border-radius: 80px;">
                <div>
                    <span class="text-orange h1">CODYZEA</span>
                    <span class="h2 text-white">Empowers Sales and Efficiency</span>
                    <span class="text-orange h1">for Modern Retailers.</span>
                </div>
            </div>
        </div>
    </div>
