...
<script src="https://assets.calendly.com/assets/external/widget.js" type="text/javascript" async></script>
            ...
            <div class="col-12 col-lg-6">
                <img src="assets/contact.jpg" class="img-fluid" alt="">
            </div>
        ...
        <div class="row space-extra">
            ...
            <div class="col-12 col-lg-6">
                <span class="display-3 text-black">
                    We’re Ready to <span class="text-orange">Visit You</span>
                </span>
                <p class="fs-4 text-black">
                    Need a face-to-face discussion? We’re happy to visit your place! Just let us know, and we’ll bring
                    our expertise right to your doorstep.
                </p>
                <div class="btn-group" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <a class="th-btn blue-btn style1 th-icon th-radius fs-5">Request a Visit<i
                    ...
                    <div class="modal-body m-0 p-0">
                        <div class="row m-0 p-0">
                            <div class="col-12 col-lg-5 p-0 m-0"
                                style="background-image: url('assets/request-meeting.jpg'); background-size: cover;">
                                <!-- <img src="assets/request-meeting.jpg" class="img-fluid m-0 p-0" alt="offersmodal"> -->
                            </div>
