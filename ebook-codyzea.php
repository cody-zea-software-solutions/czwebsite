...
<script>
  gtag('event', 'ads_conversion_Submit_lead_form_Form_s_2', {
    // <event_parameters>
  });
</script>
            ...
            <div class="col-12 col-lg-6 d-flex justify-content-center align-items-center flex-column">
                <div class="p-5 d-flex justify-content-center flex-column">
                    ...
                    <p class="text-black fs-5 fw-semibold">
                        ...
                        site’s performance. Whether you’re focused on improving load times, enhancing mobile
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6">
                <img src="assets/ebook-mockup.png" class="img-fluid" alt="webdesignillus002">
            </div>
            <div class="col-12 col-lg-6">
