...
<body>
    ...
    <div class="container-fluid px-5 py-5 px-md-0 pe-lg-5 ">
        <div class="row mt-0 mt-md-3">
            <div class="col-lg-6 mt-3 px-md-5 px-lg-0 ps-5">
                <div class="title-area mb-25 mt-n1 mt-4 text-start text-md-end text-lg-start">
                    <h1 class="sec-title text-ani-style3 text-start">Get a stunning website for less.</h>
                </div>
                <p class="mt-n2 mb-30">We'll build you an effective, affordable website that you love and that increases your sales.</p>
                <div class="info-list">
                    <div class="info-item">
            ...
            <div class="col-lg-6 d-flex justify-content-center">
                <img src="assets/kiwi-hero.webp" alt="" class="img-fluid pricing-image d-none d-md-flex">
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-md-6 col-lg-4">
                ...
                <p class="fs-5 text-o mt-2">Get a high-quality website for a fraction of the cost charged by our competitors. We design smarter to make your budget go further.</p>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
                <svg width="100px" height="100px" version="1.1" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" id="1954371169" data-icon-custom="true">
                    <g>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="text-center mt-3"><span class="display-4 text-dark fw-semibold">Join our incredible <span class="text-orange">★★★★★</span> clients</span><br>
                <span class="sub-title sub-title6 style1 text-ani-style2 mt-4 d-none d-md-inline-block text-o">There is a reason we have a constantly growing list of 5 star reviews on Google. Our clients love us and we love them! Check out some of our recent sites below, but remember - every site is unique, and we'll build you the site that YOU want.</span>
                <p class="d-md-none mt-4 px-3">There is a reason we have a constantly growing list of 5 star reviews on Google. Our clients love us and we love them! Check out some of our recent sites below, but remember - every site is unique, and we'll build you the site that YOU want.</p>
            </div>
        </div>
        <div class="row">
            <div class="fullscreen-container">
                ...
                <div class="fullscreen-wrapper">
                    <?php for ($x = 1; $x < 10; $x++) { ?>
                        <div class="fullscreen-slide <?php echo $x === 1 ? 'active-slide' : ''; ?>">
                            <div class="col-6">
                                <img src="assets/kiwi-last.webp" class="img-fluid p-5">
                            </div>
                            <div class="col-6 pe-5">
                                <h4>Helping Children Thrive: Website & Branding</h4>
                                <p class="fs-5 text-secondary fw-normal">"543 has been a great help in helping us establish our online merchandise platform. They respond willingly and in a timely manner when help is needed, and are knowledgeable of the product they offer."</p>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="text-center mt-3"><span class="display-4 text-dark fw-semibold">Pay however suits you.👍🏽 </span><br>
                ...
                <p class="d-md-none mt-4 px-3">We want to give you the opportunity to have a stunning and effective website however it suits you best. Our low cost pricing options let you choose to pay for your site up front, or pay a simple monthly fee instead.</p>
            </div>
        </div>
        <div class="row">
    ...
    <div class="container-fluid">
        ...
        <div class="row content">
            <div class="col-12 col-md-4 col-lg-6 ">
                ...
                <img src="assets/faq2.webp" class="img-fluid">
            </div>
