...
<head>
    ...
    <title>Saor - SEO Digital Marketing Agency HTML Template - Portfolio Details</title>
                        ...
                        <div class="widget widget_info  ">
                            ...
                            <div class="project-info">
                                ...
                                <div class="project-info_content">
                                    ...
                                    <h6 class="project-info_title">Michel Miller</h6>
                                </div>
                            </div>
                            <div class="project-info">
                            ...
                            <div class="project-info">
                                ...
                                <div class="project-info_content">
                                    ...
                                    <h6 class="project-info_title">21 Jun, 2024</h6>
                                </div>
                            </div>
                            <div class="project-info">
                                <div class="project-info_icon"><i class="fa-sharp fa-solid fa-location-dot"></i></div>
                                <div class="project-info_content">
                                    <p class="project-info_subtitle text-black">Address:</p>
                                    <h6 class="project-info_title">42 Hangston, USA</h6>
                                </div>
                            </div>
                        </div>
                    </aside>
